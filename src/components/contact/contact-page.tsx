...
export function ContactPageContent({ contact }: ContactPageContentProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (turnstileActive && !turnstileToken) {
      const message = "يرجى إكمال التحقق الأمني.";
      setError(message);
      notifyError(message);
      setLoading(false);
      return;
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-text/70">{contact.email}</p>
                  </div>
                </a>
                ...
                {contact.phone && (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold text-heading">الهاتف</p>
                ...
                {contact.instagram && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text/70">{instagramLabel}</p>
                    </div>
                  </a>
                )}
              </div>
